    ...
    void UpdateTexts(string jeuEnCours)
    {
        switch (jeuEnCours) {
            case "JeuPaires":
                ...
                if (MainGameManager.Instance.nbPartiePairesJoue >= 1)
                {
            ...
            case "JeuBatons":
                ...
                if (MainGameManager.Instance.nbPartieBatonJoue >= 1)
                {
                    textConsignes.gameObject.SetActive(false);
                    RectTransform rectTransform = textNbParties.GetComponent<RectTransform>();
            ...
            case "JeuClous":
                ...
                if (MainGameManager.Instance.nbPartieClouJoue >= 1)
                {
                    textConsignes.gameObject.SetActive(false);
                    RectTransform rectTransform = textNbParties.GetComponent<RectTransform>();
                    rectTransform.anchoredPosition = new Vector2(0, -466);
            ...
            case "JeuBassins":
                ...
                if (MainGameManager.Instance.nbPartieBassinJoue >= 1)
                {
                    textConsignes.gameObject.SetActive(false);
                    RectTransform rectTransform = textNbParties.GetComponent<RectTransform>();
                    rectTransform.anchoredPosition = new Vector2(0, -466);
