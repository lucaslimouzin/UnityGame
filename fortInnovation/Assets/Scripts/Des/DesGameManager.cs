        ...
        switch (jeuEnCours) {
            ...
            case "JeuBatons":
                ...
                if(MainGameManager.Instance.niveauSelect =="Normal"){
                    ...
                    textConsignes.text = "Règles du jeu :\nDes batonnets sont disposés au centre du plateau, votre mission est de ne pas retirer le dernier batonnet. \nPour retirer 1, 2 ou 3 batonnets, répondez correctement à une question sur l'innovation. En cas de mauvaise réponse, c'est au Maître du jeu de choisir le nombre de batonnets qu'il souhaite retirer.\nSi le Maître du jeu retire le dernier batonnet, vous remportez le duel.";
                    textNbParties.gameObject.SetActive(false);
                    RectTransform rectTransform = boutonCommencer.GetComponent<RectTransform>();
                    rectTransform.anchoredPosition = new Vector2(0, -330);
                }
